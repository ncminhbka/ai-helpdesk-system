...
async def login(
    ...
    return {"access_token": use_case.generate_token(user), "token_type": "bearer"}
...
async def register(
    ...
    # Đăng ký thành công thì tạo JWT cho phép đăng nhập ngay
    return {"access_token": auth_use_case.generate_token(user), "token_type": "bearer"}
